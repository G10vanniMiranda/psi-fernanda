...
export default function Home() {
  ...
  <section id="inicio" className="w-full bg-white scroll-mt-24">
        ...
        >
          ...
          {/* Left: Text */}
          <motion.div className="w-full lg:w-1/2 text-center lg:text-left" variants={fadeInUp}>
            ...
            <motion.p className="mt-4 text-gray-600 text-base sm:text-lg" variants={fadeInUp}>
            ...
            <motion.div className="mt-8 flex flex-col sm:flex-row sm:items-center sm:justify-start gap-3 sm:gap-4" variants={fadeInUp}>
          ...
          {/* Right: Photo */}
          <motion.div className="w-full lg:w-1/2 flex items-center justify-center" variants={fadeIn}>
  ...
  <section id="problemas" className="w-full bg-gray-50 scroll-mt-24">
        ...
        >
          ...
          <motion.h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 text-center" variants={fadeInUp}>
            Você sente que está sobrecarregado(a) e não sabe por onde começar?
          </motion.h2>

          <motion.p className="mt-4 text-center text-gray-600 max-w-2xl mx-auto" variants={fadeInUp}>
          ...
          <motion.ul className="mt-8 grid gap-3 sm:grid-cols-2" variants={stagger}>
            ...
            <motion.li className="flex items-start gap-3 sm:col-span-2" variants={fadeInUp}>
              <svg aria-hidden="true" className="w-6 h-6 text-emerald-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3"></path></svg>
          ...
          <motion.p className="mt-6 text-center text-sm text-gray-700" variants={fadeInUp}>Você não precisa enfrentar isso sozinho(a).</motion.p>
  ...
  <section id="solucao" className="w-full bg-white scroll-mt-24">
        ...
        >
          ...
          <motion.p className="mt-4 text-center text-gray-600 max-w-3xl mx-auto" variants={fadeInUp}>
          ...
          <motion.div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4" variants={stagger}>

            <motion.div className="p-6 bg-gray-100 rounded-lg text-center" variants={fadeInUp} whileHover={{ y: -4, scale: 1.01 }}>
  ...
  <section id="sobre" className="w-full bg-gray-50 scroll-mt-24">
        ...
        >
          ...
          <motion.div className="w-full lg:w-1/2 flex items-center justify-center" variants={fadeIn}>
            ...
            <motion.div className="w-56 h-56 rounded-xl overflow-hidden shadow-lg bg-gray-100" variants={fadeInUp}>
          ...
          <motion.div className="w-full lg:w-1/2" variants={fadeInUp}>
            ...
            <motion.div className="mt-6 inline-flex items-center gap-4 flex-wrap" variants={stagger}>

              <motion.div className="flex items-center gap-2 bg-white px-3 py-2 rounded shadow-sm" variants={fadeInUp}>
  ...
  <section id="beneficios" className="w-full bg-white scroll-mt-24">
        ...
        >
          ...
          <motion.h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 text-center" variants={fadeInUp}>Como a terapia pode transformar sua vida</motion.h2>

          <motion.div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 items-center" variants={stagger}>

            <motion.div className="p-6 bg-gray-50 rounded-lg shadow-sm" variants={fadeInUp} whileHover={{ y: -4, scale: 1.01 }}>
            ...
            <motion.div className="p-6 bg-gray-50 rounded-lg shadow-sm sm:col-span-2 lg:col-span-1" variants={fadeInUp} whileHover={{ y: -4, scale: 1.01 }}>
  ...
  <section id="depoimentos" className="w-full bg-gray-50 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <motion.div className="mt-10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
  ...
  <section id="faq" className="w-full bg-white scroll-mt-24">
        ...
        >
          ...
          <motion.h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 text-center" variants={fadeInUp}>Dúvidas frequentes</motion.h2>

          <motion.div className="mt-8 space-y-4" variants={stagger}>

            <motion.details className="bg-gray-100 p-4 rounded-lg" variants={fadeInUp}>
  ...
  <div id="contato" className="h-0 scroll-mt-24" aria-hidden="true"></div>
      <section id="cta-final" className="w-full bg-emerald-50 scroll-mt-24">
            ...
            >
              ...
              <motion.h2 className="text-2xl sm:text-3xl font-semibold text-gray-900" variants={fadeInUp}>Cuide de quem mais importa: você.</motion.h2>
              <motion.p className="mt-4 text-gray-700" variants={fadeInUp}>Agende sua primeira sessão e dê o primeiro passo para uma vida emocionalmente mais leve.</motion.p>
